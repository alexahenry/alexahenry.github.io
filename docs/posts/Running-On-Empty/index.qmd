...
ggplot() + 
  ...
  facet_wrap(~Team)
```
In conclusion, Maryland's rushing average has taken a sharp turn since Oct. 15 and looks like it's on a spiral since then. Looking at teams like Penn State and Michigan, they have maintained the Big Ten average. 
